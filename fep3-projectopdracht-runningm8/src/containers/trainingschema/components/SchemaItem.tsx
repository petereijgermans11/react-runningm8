...
export function SchemaItem({schema, index}: {schema: TrainingSchema, index: number}) {
                ...
                <div className={'previewContentContainer'}>
                    <div className={'previewSummaryContainer'}>
                        <div className={'previewSummary'}>
                            <h4 className={'summaryLabel'}>{t('schemas:workoutTime')}</h4>
                            <h4 className={'summaryLabel'}>{t('schemas:exercises')}</h4>
                            <h4 className={'summaryLabel'}>{t('schemas:published')}</h4>
                        </div>
                        <div className={'previewSummary'}>
                    ...
                    <div className={'metaContainer'}>
                        <div style={{color: schema.difficulty === 'Hard' ? 'red': schema.difficulty === 'Medium' ? 'orange' : 'green'}}>{t('common:' + schema.difficulty)}</div>
                    </div>
                </div>
            </div>
            {/*// actual modal*/}
            <SchemaModal mine schema={schema} index={index}/>
        </ScreenModal>
